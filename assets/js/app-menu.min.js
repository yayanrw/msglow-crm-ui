  ...
  (a.app.menu = {
    ...
    manualScroller: {
      ...
      updateHeight: function () {
        ("vertical-menu" != s.data("menu") &&
          "vertical-menu-modern" != s.data("menu") &&
          "vertical-overlay-menu" != s.data("menu")) ||
    ...
    drillDownMenu: function (e) {
      a(".drilldown-menu").length &&
        ("sm" == e || "xs" == e
          ? "true" == a("#navbar-mobile").attr("aria-expanded") &&
            a(".drilldown-menu").slidingMenu({ backLabel: !0 })
          : a(".drilldown-menu").slidingMenu({ backLabel: !0 }));
    },
    change: function (e) {
      ...
      if (n)
        switch (n.name) {
          ...
          case "lg":
            ...
            break;
          case "md":
            "vertical-overlay-menu" === o || "vertical-menu-modern" === o
              ? this.hide()
              : this.collapse();
            break;
          case "sm":
      ...
      ("vertical-menu" !== o && "vertical-menu-modern" !== o) ||
        this.toOverlayMenu(n.name, o),
        s.is(".horizontal-layout") &&
          !s.hasClass(".horizontal-menu-demo") &&
          (this.changeMenu(n.name), a(".menu-toggle").removeClass("is-active")),
        ...
        ("vertical-menu" !== o && "vertical-overlay-menu" !== o) ||
          ((jQuery.expr[":"].Contains = function (e, n, a) {
            return (
              (e.textContent || e.innerText || "")
                .toUpperCase()
                .indexOf(a[3].toUpperCase()) >= 0
            );
          }),
    ...
    transit: function (e, n) {
      ...
      s.addClass("changing-menu"),
        e.call(i),
        s.hasClass("vertical-layout") &&
          (s.hasClass("menu-open") || s.hasClass("menu-expanded")
      ...
      this.transit(
        function () {
          s.removeClass("menu-hide menu-collapsed").addClass("menu-open"),
            (this.hidden = !1),
            (this.expanded = !0),
            s.hasClass("vertical-overlay-menu") &&
    ...
    expand: function () {
      !1 === this.expanded &&
        ("vertical-menu-modern" == s.data("menu") &&
          a(".modern-nav-toggle")
            .find(".toggle-icon")
            .removeClass("feather icon-toggle-left")
            .addClass("feather icon-toggle-right"),
        this.transit(
          function () {
    ...
    collapse: function (n) {
      !1 === this.collapsed &&
        ("vertical-menu-modern" == s.data("menu") &&
          a(".modern-nav-toggle")
            .find(".toggle-icon")
            .removeClass("feather icon-toggle-right")
            .addClass("feather icon-toggle-left"),
        this.transit(
          function () {
    ...
    toOverlayMenu: function (e, n) {
      ...
      "vertical-menu-modern" == n
        ? "md" == e || "sm" == e || "xs" == e
          ? s.hasClass(a) && s.removeClass(a).addClass("vertical-overlay-menu")
          : s.hasClass("vertical-overlay-menu") &&
            s.removeClass("vertical-overlay-menu").addClass(a)
        : "sm" == e || "xs" == e
        ? s.hasClass(a) && s.removeClass(a).addClass("vertical-overlay-menu")
        : s.hasClass("vertical-overlay-menu") &&
          s.removeClass("vertical-overlay-menu").addClass(a);
    ...
    toggle: function () {
      ...
      switch (e.name) {
        ...
        case "lg":
          !0 === n
            ? "vertical-overlay-menu" == i || "horizontal-menu" == i
              ? this.hide()
              : this.collapse()
            : "vertical-overlay-menu" == i || "horizontal-menu" == i
            ? this.open()
        ...
        a(".navigation-main")
            ...
            if (
              ...
              if (
                ...
                (o = n.css("border-top")
                  ...
                  : n.position().top),
                "vertical-compact-menu" !== s.data("menu") &&
                  l
          ...
          a("ul.menu-content").on("click", "li", function (n) {
            ...
            if (s.is(".disabled")) n.preventDefault();
              ...
              s.is(".active") ||
                (s.siblings(".active").trigger("deactive.app.menu"),
      ...
      adjustSubmenu: function (e) {
        ...
        a(".main-menu-header").height(),
          ...
          parseInt(e.css("border-top"), 10) > 0 &&
            (l = parseInt(e.css("border-top"), 10)),
          (o = t - n - e.height() - 30),
          a(".main-menu").hasClass("menu-dark"),
          (s = n + e.height() + l),
          d
            ...
            .appendTo(".main-menu-content")
            .css({ top: s, position: "fixed", "max-height": o });
